      ...
      <div className="container">
        <div className="section">
          <div className="flex items-center gap-2">
            ...
            <span className="uppercase">One spot avalaible for next month</span>
          </div>
              ...
              <Button
                ...
                iconAfter={
                  <div className="size-6 overflow-hidden">
                    <div className="w-12 h-12 flex transition-transform duration-300 group-hover/button:-translate-x-1/2">
                      <svg
        ...
        <p className="py-16 text-white/30 text-sm">
          Copyright &copy; Titin Astina &bull; All Rights Reserved
        </p>
      </div>
    </footer>
  );
