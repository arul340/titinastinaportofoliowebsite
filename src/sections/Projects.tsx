...
const projects = [
  ...
  {
    name: "English for Kids and Adults",
    image: image4,
  },
  {
        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {projects.map(({ name, image }) => (
            <a
              href="#"
              key={name}
              className="border-t border-stone-400 py-6 md:py-8 lg:py-10 border-dotted flex flex-col relative group/project"
            >
              ...
              <div className="relative">
                ...
                <div className="mt-8 md:mt-0 flex justify-between items-center md:grid md:[grid-template-columns:1fr_300px_max-content] md:gap-8">
                  ...
                  <div className="lg:group-hover/project:pr-8 transition-all  duration-700">
                    <div className="size-6 overflow-hidden z-20">
