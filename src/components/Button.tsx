  ...
  return (
    <button
      className={twMerge(
        ...
        variant === "text" &&
          "h-auto px-0 border-transparent after:transition after:duration-500 after:content-[''] after:h-px after:w-0 after:absolute after:top-full after:bg-red-orange-500 hover:after:w-full",
        className
      )}
      {...rest}
    >
